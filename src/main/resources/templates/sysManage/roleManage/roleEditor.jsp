...
<%
    String roleQueryUrl = "view/index.jsp?sysManage/roleManage/roleQuery#sysManage/roleManage/roleQuery";
%>
...
<script type="text/javascript">
    var roleQueryUrl = "view/index.jsp?sysManage/roleManage/roleQuery#sysManage/roleManage/roleQuery";
