...
<div class="container-fluid" style="margin-top: 20px;">
    <form class="form-horizontal" id="roleForm" action="#" method="post"
        ...
        <div class="form-group">
            <label for="roleId_1" class="col-xs-offset-2 col-sm-2 control-label">角色名称：</label>
            <div class="col-xs-4">
...
<script type="text/javascript">
  var insertUrl = "roles/insert.do";
  function submitForm() {
      _window._showShade();
      $.ajax({
          type: "POST",
          url: insertUrl,
          data: {rolename: $('#roleName_1').val()},
          success: function (msg) {
              _window._closeShade();
              if (msg.code == 1) {
                  _window._confirm('添加角色成功!', function () {
                  }, true)
                  _window._colsePopup();
              } else {
